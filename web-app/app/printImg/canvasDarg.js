define(function() {
	...
	function divDrag(){
		new Resize(byId('ss')).set(byId('rUp'),'up').set(byId('rDown'),'down').set(byId('rLeft'),'left').set(byId('rRight'),'right').set(byId('rLeftUp'),'leftUp').set(byId('rLeftDown'),'leftDown').set(byId('rRightDown'),'rightDown').set(byId('rRightUp'),'rightUp');
	}
	return {
		divDrag:divDrag
	}
