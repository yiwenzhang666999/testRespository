...
define(function () {
     ...
     * 添加一个属性查询高亮图层
     */
    function get_attrQuery_layer() {
         var attrQuery_layer = new ol.layer.Vector({
         	 zIndex:99998,
             source: new ol.source.Vector(),
             style: function (feature) {
                 if (feature.get('style')) {
         ...
         return attrQuery_layer;
     }    
     /**
     * 获得审核地块-网格未完成标注图层
     * @returns 
     */
    function get_shdk_p_wwc_layer() {
        var shdk_p_wwc_layer = new ol.layer.Vector({
        	zIndex:99998,
            source: new ol.source.Vector(),
            style: function (feature) {
                if (feature.get('style')) {
    ...
    return {
        ...
        get_shdk_p_wwc_layer:get_shdk_p_wwc_layer,
        get_shdk_high_layer:get_shdk_high_layer,
        get_attrQuery_layer:get_attrQuery_layer,
    }
});