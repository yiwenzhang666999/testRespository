...
//findNeighbours(data,[114.032,27.55],2);
window.findNeighbours=function (data,arr,num){
	if(data.length==0){
		return;
	}
	data=data.map(arrToBox);
	var tree = rbush().load(data);
    var result = knn(tree, arr[0], arr[1], num);
//    console.log(result);
    return result;
}
},{"rbush":4,"rbush-knn":3}],2:[function(require,module,exports){
'use strict';
...
},{"quickselect":2}],5:[function(require,module,exports){
'use strict';
