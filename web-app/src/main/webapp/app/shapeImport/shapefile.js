...
var shp_read = function() {
  ...
  return that._source.slice(12).then(function(array) {
    ...
    if(that._source._array.length==that._source._index){
    ...
    function read() {
      ...
      return length < 0 || (type && type !== that._type) ? skip() : that._source.slice(length).then(function(chunk) {
    	  var temp={done: false, value: type ? that._parse(view(concat$1(array.slice(8), chunk))) : null};
//    	  console.log(temp);
...
function open(shp$$1, dbf$$1, options) {
  ...
  if (typeof shp$$1 === "string") {
    ...
    if (dbf$$1 === undefined){
    	dbf$$1 = path(shp$$1.substring(0, shp$$1.length - 4) + ".dbf", options).catch(function() {});
    } 
...
exports.Shp = Shp;
exports.view = view;
exports.shp_read = shp_read;
exports.shapefile_read = shapefile_read;
exports.slice_slice = slice_slice;
